...
const Cliente = ({cliente, handleEliminar}) => {
  ...
  return (
    <tr className="border-b hover:bg-gray-50">
        ...
        <td className="p-3">
            <p><span className="text-gray-800 uppercase font-bold">Email: </span> <a href={`mailto:${email}`}>{email}</a></p>
            <p><span className="text-gray-800 uppercase font-bold">Teléfono: </span><a href={`tel:${telefono}`}>{telefono}</a></p>
        </td>
